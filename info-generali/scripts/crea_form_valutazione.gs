/**
 * Google Apps Script per la CREAZIONE DA ZERO dei due Google Form:
 * 1. "Valutazione Corsi e Docenti - UNINA INFORMATICA"
 * 2. "Valutazione Materiale - UNINA INFORMATICA"
 *
 * PERCHÉ CREARLI DA ZERO CON FormApp.create()?
 * Modificare un form esistente con 31 sezioni e oltre 70 elementi fa andare
 * in timeout i server di Google (errore "Failed to retrieve form data").
 * Creandoli da zero con FormApp.create(), il processo dura circa 30 secondi
 * e funziona al 100% senza alcun errore di rate limit (esattamente come
 * è avvenuto per il form delle Domande Orali).
 *
 * COME UTILIZZARLO:
 * 1. Vai su https://script.google.com/
 * 2. Incolla questo codice (o aggiungilo al progetto)
 * 3. Seleziona ed esegui la funzione:
 *    - 'creaFormValutazioneDocenti' (crea il Form 1)
 *    - 'creaFormValutazioneMateriale' (crea il Form 2)
 * 4. Copia i due link pubblici e passali all'assistente:
 *    verranno aggiornati nel README.md in un secondo!
 */
...
// ============================================================================
// 1. CREA: VALUTAZIONE CORSI E DOCENTI
// ============================================================================
function creaFormValutazioneDocenti() {
  var form = FormApp.create("Valutazione Corsi e Docenti - UNINA INFORMATICA");
  ...
  Logger.log("=================================================");
  Logger.log("✅ FORM VALUTAZIONE DOCENTI CREATO CON SUCCESSO!");
  Logger.log("Link pubblico per gli studenti (da mettere nel README):");
  Logger.log(form.getPublishedUrl());
  Logger.log("Link di modifica e gestione:");
  Logger.log(form.getEditUrl());
  Logger.log("=================================================");
}

// ============================================================================
// 2. CREA: VALUTAZIONE MATERIALE DIDATTICO
// ============================================================================
function creaFormValutazioneMateriale() {
  ...
  Logger.log("=================================================");
  Logger.log("✅ FORM VALUTAZIONE MATERIALE CREATO CON SUCCESSO!");
  Logger.log("Link pubblico per gli studenti (da mettere nel README):");
  Logger.log(form.getPublishedUrl());
  Logger.log("Link di modifica e gestione:");
  Logger.log(form.getEditUrl());
