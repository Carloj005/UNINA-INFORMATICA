...
- **Integrazione Nuove Risorse Didattiche:**
  ...
  - Aggiunte e normalizzate le slide per *Ingegneria del Software* (Prof. Sergio Di Martino) in `Terzo Anno/Primo Semestre/Ingegneria del Software/Prof-Sergio Di Martino/slides/`: "Lezione 00 Introduzione al corso.pdf" e "Lezione 01 Software Process And Quality.pdf".
  - Aggiunte risorse per *Reti e Programmazione Distribuita* (Prof. Alberto Finzi): slide del corso ("Lezione 00 Introduzione al corso.pdf", "Lezione 01.pdf", "Lezione 02.pdf") in `slides/`, libro di testo *Computer Networking: A Top-Down Approach* (7th Ed.) in `libri/`, mappa concettuale in `appunti/` e aggiornato `README.md` con codice Teams 2026/2027 (`rpmzm7k`), modalità d'esame (Scritto + Orale, Preappello disponibile) e testi consigliati.
  - Aggiunte e normalizzate le slide per *Tecnologie Web* (Prof. Starace) in `Terzo Anno/Primo Semestre/Tecnologie Web/Prof-L.L.L.Starace/slides/`: "Lezione 00 - Introduzione.pdf", "Lezione 01 - DNS.pdf", "Lezione 02 - HTTP.pdf" e "Lezione 03 - HTTP (2).pdf".
  ...
  - Integrati tramite Pull Request (#21 di `valenty29`) gli appunti delle lezioni 1 e 2 di Geometria A.A. 2026/2027 redatti da Annunziata, collocati secondo gli standard in `Secondo Anno/Primo Semestre/Geometria/Prof-FrancescaCioffi/contenuto-non-proprio/Appunti-Lezione-Annunziata/` con rispettivo `crediti.txt`.
